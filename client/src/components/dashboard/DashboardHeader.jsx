  ...
  <div className="bg-gradient-to-r from-[#003049] to-[#669BBC] text-white p-6 rounded-t-lg shadow-lg">
    <div className="flex flex-col md:flex-row justify-between items-start md:items-center">
      ...
      <div className="mt-4 md:mt-0 flex flex-wrap gap-3">
        ...
        <button
          className="bg-[#003049] text-white px-5 py-2 rounded-lg hover:bg-[#00243a] transition-colors shadow-md flex items-center gap-2"
        ...
        <button
          className="bg-white text-[#003049] px-5 py-2 rounded-lg hover:bg-gray-100 transition-colors shadow-md flex items-center gap-2"
          onClick={onAddUser}
        >
